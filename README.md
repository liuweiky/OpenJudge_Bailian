...
优化：对每一级的设备按 price 非降序排序，在确定某一级应选择的设备时，只需从 0 开始选择第一个 bandwidth 大于等于 d.bandwidth 的设备即可。time：431ms -> 70ms.

## 1019:Number Sequence

[Problem description](http://bailian.openjudge.cn/practice/1019/)

[C++ (Accepted)](https://github.com/Heliovic/OpenJudge_Bailian/blob/master/1019/main.cpp)
